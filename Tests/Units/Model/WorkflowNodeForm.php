...
class WorkflowNodeForm extends Units\Test
{
	...
	public function test_execute_many_manual()
	{
		...
		$mockExecute->setVariable('form_test1_response', array('data1'=>'toto'));
		//Execute le node
		$this->assert->boolean($node->execute($mockExecute))->isFalse();
		...
		$mockExecute->setVariable('form_test1_response', array('data1'=>'tata'));
		//var_dump($mockExecute->getVariables());
		...
		$mockExecute->setVariable('form_test1_response', array('id'=>0, 'data1'=>'replace'));
		//var_dump($mockExecute->getVariables());
		...
		$mockExecute->setVariable('form_test1_response', array('id'=>50, 'data1'=>'replace invalid key'));
		//var_dump($mockExecute->getVariables());
	...
	public function test_execute_many_max_3_manual()
	{
		...
		$mockExecute->setVariable('form_test1_response', array('id'=>50, 'data1'=>'overload data'));
		$mockExecute->setVariable('form_test1_continue', true);
		//var_dump($mockExecute->getVariables());
	...
	public function test_unit_auto()
	{
		...
		//Enregistre une réponse
		//var_dump($mockExecute->getVariables());
		$mockExecute->setVariable('form_test1_response', array('id'=>0, 'data1'=>'tata'));
		//var_dump($mockExecute->getVariables());
