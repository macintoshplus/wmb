...
{
	/**
	 * WorkflowDatabaseDefinitionStorage
	 *
	 * @var WorkflowDatabaseDefinitionStorage
	 **/
	...
	public function __construct(EntityManager $entityManager, WorkflowDatabaseDefinitionStorage $definitionService, SecurityContextInterface $security)
	{
